...
namespace ResultSystem.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        private static double CalculateCourseResult(Result res)
        {
            ...
            else if ( total >= 70 ) return 3.3;
            else if ( total >= 65 ) return 3.0;
            else if ( total >= 60 ) return 2.7;
            else if ( total >= 55 ) return 2.3;
            else if ( total >= 50 ) return 2.0;
            else if ( total >= 45 ) return 1.7;
            else if ( total >= 40 ) return 1.3;
